...
equationOfTime::usage="equationOfTime[x] calculates the equation of time in a given day number";


solarHourAngleCorrectedByLongitude::usage="Corrects the hour according to longitude   | use as follows [hour,longitude_,GMT, day number]";


solarDeclination::usage="Corrects the hour according to number's day on the year  | use as follows [day number]";


solarAltitude::usage="calculate the solar altitude according to the hour   | use as follows [latitude,day number,hour,longitude,GMT]";


radnormalextra::usage="Estimates the normal extraterrestrial solar radiation   | use as follows [day number]";


radhorextra::usage="Estimates the horizontal extraterrestrial solar radiation   | use as follows [latitude,day number,hora,longitude,GMT]";


clearnessIndex::usage="Estimates the relation between global solar radiation and extraterrestrial solar radiation  | use as follows [radglobhorizontal_,day number]";


erbsCorrelation::usage="Calculates the Erbs correlation based on clearness index  | use as follows [radglobhorizontal,day number]";


diffuseSolarRadiation::usage="Calculates the fraction of diffuse solar radiation  | use as follows [radglobhorizontal,day number]";


directSolarRadiation::usage="Calculates the fraction of direct solar radiation  | use as follows [radglobhorizontal,day number]";


cos\[Theta]LatNoth::usage="Calculates cos\[Theta] for North Latitudes | use as follows [day number,hora,GMT,latitude,longitude,inclination]";


cos\[Theta]z::usage="Calculates cos\[Theta]z for North Latitudes | use as follows [day number,hora,GMT,latitude,longitude,inclination]";


rbFactor::usage="Calculates the RB Factor (cos\[Theta]/cos\[Theta]z) | use as follows [day number,hora,GMT,latitude,longitude,inclination]";


solarRadiationOnInclinedSurfaceLatNorth::usage="Calculates the solar radiation on a inclined surface for Latitude North and Azimute 0 or 180 | use as follows [radglobhorizontal_,day number_,hora_,GMT_,latitude_,longitude_,inclination_,al_]";
